...
@onready var weapon_element_label: Label = $Center/MainColumn/MainCard/Margins/MainRow/RightColumn/RightVBox/WeaponStatsBox/MetaRow/WeaponElementLabel
@onready var damage_bar: ProgressBar = $Center/MainColumn/MainCard/Margins/MainRow/RightColumn/RightVBox/WeaponStatsBox/DamageRow/DamageBar
@onready var fire_rate_bar: ProgressBar = $Center/MainColumn/MainCard/Margins/MainRow/RightColumn/RightVBox/WeaponStatsBox/FireRateRow/FireRateBar
@onready var damage_value_label: Label = $Center/MainColumn/MainCard/Margins/MainRow/RightColumn/RightVBox/WeaponStatsBox/DamageRow/DamageValueLabel
@onready var fire_rate_value_label: Label = $Center/MainColumn/MainCard/Margins/MainRow/RightColumn/RightVBox/WeaponStatsBox/FireRateRow/FireRateValueLabel
